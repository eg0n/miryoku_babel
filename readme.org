...
#+NAME: hold
| BOOT     | DF(U_TAP) | DF(U_EXTRA) | DF(U_BASE) | RESET   | RESET | DF(U_BASE) | DF(U_EXTRA) | DF(U_TAP) | BOOT     |
...
| OUT_TOG | U_NP     | DT_DOWN  | DT_UP    | U_NP     |
...
| U_NP     | DT_DOWN  | DT_UP    | U_NP     | OUT_TOG |
| MSTP     | MPLY     | MUTE     | U_NP     | U_NP    |
...
| DT_DOWN     | DT_DOWN          |               |               | Tap Term Down |               |
| DT_UP       | DT_UP            |               |               | Tap Term Up   |               |
...
| RBRC        | RBRC             | RBKT          | ]             | ]             | RBRC          |
| RCBR        | RCBR             | RBRC          | }             | }             | RCBR          |
| RESET       | TD(U_TD_RESET)   | &reset        |               | Reset         | RESET         |
...
: "Boot",            U_DF(U_TAP),       U_DF(U_EXTRA),     U_DF(U_BASE),      "Reset",           "RGB Toggle",      "RGB Mode",        "RGB Hue",         "RGB Sat",         "RGB Val",         \
...
#+NAME: nonkc
| U_ | RGB_ | OU_  | QK_ | S( | C( | SCMD( | LCMD( | TD( | CW_TOGG | DT_
